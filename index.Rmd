...
## In statistics each rule is general but each design is specific **so drive decision with design.**
 ...
 > - **Corollary 2:** If the design was _not_ randomized, what I am thinking about when I calculate a standard error or a p-value? This mental design can stand in for actual design. (i.e. If we had a randomized  experiment or a random sample in this case, what would have been repeatable?)
